 ...
 */
package com.fng.foxnation.qa.ui;

import static com.fng.foxnation.qa.TrivialDriveRepository.SKU_PREMIUM;
...
import com.fng.foxnation.qa.MakePurchaseViewModel;
import com.fng.foxnation.qa.R;
import com.fng.foxnation.qa.TrivialDriveApplication;
import com.fng.foxnation.qa.TrivialDriveRepository;
import com.fng.foxnation.qa.databinding.FragmentMakePurchaseBinding;
...
public class MakePurchaseFragment extends Fragment {
    ...
    void makeInventoryList() {
        ...
        inventoryList.add(new MakePurchaseAdapter.Item(
                com.fng.foxnation.qa.TrivialDriveRepository.SKU_PREMIUM, MakePurchaseAdapter.VIEW_TYPE_ITEM
        ));
        inventoryList.add(new MakePurchaseAdapter.Item(
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new android.os.Handler().postDelayed(() -> makePurchase(TrivialDriveRepository.SKU_GAS), 4000);
    }
    ...
    public LiveData<Boolean> canBuySku(String sku) {
        android.util.Log.d(TAG, "canBuySku: " + sku);
